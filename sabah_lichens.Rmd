...
(Check whether exclusion of rare taxonomic/functional groups (e.g. overall mean abundance $\leq$ 0.01) alters results substantially.)
...
![(a) CAP ordination plot of lichen community structure (taxonomic groups) according to environmental variables (vectors represent Spearman rank correlation coefficients with axes). (b) Spearman rank correlation coefficients between CAP axes and individual taxa for which $|\rho| \geq 0.5$.](./figs/cap_taxa.pdf)

![(a) CAP ordination plot of lichen community structure (functional groups) according to environmental variables (vectors represent Spearman rank correlation coefficients with axes). (b) Spearman rank correlation coefficients between CAP axes and individual functional groups for which $|\rho| \geq 0.5$.](./figs/cap_func.pdf)

(Describe correlations of taxonomic/functional groups with CAP axes and environmental variables.)
