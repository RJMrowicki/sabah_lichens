...
Analysis of variance (ANOVA) was used to test for differences in lichen taxonomic and functional group richness and diversity among sites. Tests were based on Type II Sums of Squares owing to unequal numbers of observations among groups.
...
As expected, lichen richness and diversity (in terms of both taxonomic and functional groups) appeared to be lower at the disturbed site compared to the other two sites. While ANOVAs indicated significant differences in all cases, these results must be interpreted with caution owing to the poor fit of data to models -- specifically, assumptions of normality and/or homoscedasticity were contravened. (Perhaps the data are zero-inflated?)
