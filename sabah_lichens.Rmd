...
However, only the proportion of dipterocarps (and not bark type diversity) was significantly related to lichen community structure (taxonomic groups: pseudo-_F_~1,19~ = `r rep_2dp(cap_taxa_plot_margin_f["dipterocarp_prop"])`, P `r rep_p(cap_taxa_plot_margin_p["dipterocarp_prop"])`; functional groups: pseudo-_F_~1,19~ = `r rep_2dp(cap_func_plot_margin_f["dipterocarp_prop"])`, P `r rep_p(cap_func_plot_margin_p["dipterocarp_prop"])`) and functional trait composition (pseudo-_F_~1,19~ = `r rep_2dp(cap_traits_plot_margin_f["dipterocarp_prop"])`, P `r rep_p(cap_traits_plot_margin_p["dipterocarp_prop"])`).
