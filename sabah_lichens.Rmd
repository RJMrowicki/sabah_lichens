...
To enable plot-level characterisation of tree traits, we calculated (1) the Shannon-Wiener diversity of bark type, and the proportion of (2) large trees (i.e. girth $\geq$ 200 cm), (3) trees with buttresses or flutes and (4) dipterocarp trees within each plot.
