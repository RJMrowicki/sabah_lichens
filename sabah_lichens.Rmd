...
To enable plot-level characterisation of tree traits, we calculated the Shannon-Wiener diversity of (1) girth category and (2) bark type, and the proportion of (3) trees with buttresses or flutes and (4) dipterocarp trees within each plot.
