...
PerANOVA tables (taxonomic group _S_):
...
PerANOVA tables (taxonomic group $1-\lambda$):
...
PerANOVA tables (taxonomic group _H\'_):
...
PerANOVA tables (functional group FRic):
...
PerANOVA tables (functional group FEve):
...
PerANOVA tables (functional group FDiv):
...
PerANOVA tables (functional group FDis):
...
PerANOVA tables (tree bark type diversity):
...
PerANOVA tables (tree pH category diversity):
...
PerANOVA tables (proportion of large trees):
...
PerANOVA tables (proportion of trees with buttresses/flutes):
...
PerANOVA tables (proportion of dipterocarps):
...
PERMANOVA tables (taxonomic groups):
...
PERMANOVA tables (functional groups):
...
PERMANOVA tables (trait classes):
